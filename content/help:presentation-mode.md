...
coverImage: https://images.ctfassets.net/spoqsaf9291f/NZ8bL9ViOVVB5tNdjzYwH/b1630eec4c2163284c73e67b6806132d/Presentation_mode.png
...
1. Open or create a Notion page

2. Write your content — each section will become a slide

3. Insert a Divider block between sections by typing `/divider` or `---` on a new line

4. The first slide is always your page title (with icon, if set)

5. Open the `•••` menu at the top right of the page and select **Present**
...
* **Three-dot menu:** Open the `•••` menu at the top right of the page and select `Present`

* **Keyboard shortcut:** Press `⌘ + Option + P` on Mac or `Ctrl + Alt + P` on Windows/Linux

* **Six-dot menu:** To present from a specific block, click the **⋮⋮** symbol and choose `Present from here`
...
* Click **X** or press `Escape` to exit and return to the normal page view
