...
Once you've set your own workspace domain, it will be displayed at the start of any public page URLs, such as `acme.notion.site`. The unique `acme.notion.site` URL is **only used for publicly shared pages** from within your workspace. Internally, you will still see the URL as `app.notion.com/p/acme`.
