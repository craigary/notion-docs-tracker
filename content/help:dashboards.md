...
Widgets form the building blocks of dashboard views. Each widget displays a view from the same database.
...
* If drag handles aren’t visible, right-click the widget or click its header to open the widget settings.
