...
coverImage: "https://img.youtube.com/vi/k-6ldiWIDsg/maxresdefault.jpg"
category: "Developer Platform"
categoryKey: "category:developer-platform"
---

Notion CLI `ntn` is a command-line interface tool that lets developers and AI coding assistants read and update Notion by typing commands, instead of clicking around in the Notion app. You can read and write Notion content, and (if you have access) manage Workers from the command line.

This article is a high-level overview. For technical setup, see the [developer documentation](https://developers.notion.com/guides/get-started/overview)[.](https://developers.notion.com/guides/get-started/overview)

### What to know before you start

* The CLI is designed for developers and technical builders.

* The CLI is free to use on all plans. However, deploying and managing [Notion Workers](https://www.notion.com/help/run-custom-code-with-workers) requires a Business or Enterprise plan.
...
5. **Still stuck?&#x20;**&#x55;se the [developer docs](https://developers.notion.com/guides/get-started/overview) for the exact error and fix, since the steps can be different for each command.
