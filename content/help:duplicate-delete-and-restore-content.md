...
2. In the top-right corner of the page, click `•••`.
...
* You will see an **Archived** banner at the top of the page.

* It is hidden from search by default.

  * You can still include archived pages in search by filtering by `Content status` → `All pages (including archived)`.
